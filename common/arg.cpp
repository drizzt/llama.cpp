...
common_params_context common_params_parser_init(common_params & params,
    ...
    add_opt(
        common_arg(
            ...
            .set_env("LLAMA_ARG_CHECKPOINT_EVERY_NT")
            .set_examples({ LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI }));
    ...
    add_opt(
        common_arg(
            ...
            .set_spec().set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_LOOKUP, LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI })
    ...
    add_opt(common_arg(
                ...
                [](common_params & params, const std::string & value) { params.speculative.draft.p_min = std::stof(value); })
                .set_spec().set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI })
    ...
    add_opt(
        common_arg({ "-cd", "--ctx-size-draft" }, "N",
                   ...
                   [](common_params & params, int value) { params.speculative.draft.n_ctx = value; })
            .set_spec().set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI })
    ...
    add_opt(common_arg(
                ...
                [](common_params & params, const std::string & value) { params.speculative.draft.mparams.path = value; })
                .set_spec().set_examples({ LLAMA_EXAMPLE_SPECULATIVE, LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_CLI })
    ...
    add_opt(common_arg({ "-ctkd", "--cache-type-k-draft" }, "TYPE",
                ...
                .set_spec().set_env("LLAMA_ARG_CACHE_TYPE_K_DRAFT"));
    add_opt(common_arg({ "-ctvd", "--cache-type-v-draft" }, "TYPE",
                ...
                .set_spec().set_env("LLAMA_ARG_CACHE_TYPE_V_DRAFT"));
    ...
    add_opt(common_arg({ "-sl", "--src-lang" }, "LANG", string_format("source language code"),
                       [](common_params & params, const std::string & value) { params.nllb_src_lang = value; })
                .set_examples({ LLAMA_EXAMPLE_NLLB }));

    add_opt(common_arg({ "-tl", "--tgt-lang" }, "LANG", string_format("target language code"),
                       [](common_params & params, const std::string & value) { params.nllb_tgt_lang = value; })
                .set_examples({ LLAMA_EXAMPLE_NLLB }));

    add_opt(common_arg({ "--beam-size" }, "N",
                       string_format("beam size for beam search (default: %d, greedy)", params.nllb_beam_size),
                       [](common_params & params, int value) { params.nllb_beam_size = value; })
                .set_examples({ LLAMA_EXAMPLE_NLLB }));
...
void common_params_add_preset_options(std::vector<common_arg> & args) {
    ...
    args.push_back(common_arg({ "hidden" }, "in server router mode, hide this model from the /models endpoint",
                              [](common_params &) { /* unused */ })
                       .set_env(COMMON_ARG_PRESET_HIDDEN)
                       .set_preset_only());
